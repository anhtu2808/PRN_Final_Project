...
namespace LaptopRentalManagement.Areas.Manage.Pages.Categories
{
    public class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostCreateAsync(string name, string description)
        {
            ...
            {
                return new JsonResult(new { success = false, errors = new { General = new[] { "Lỗi khi tạo danh mục: " + ex.Message } } });
            }
        }
        ...
        public async Task<IActionResult> OnPostUpdateAsync(int categoryId, string name, string description)
        {
            ...
            {
                return new JsonResult(new { success = false, errors = new { General = new[] { "Lỗi khi cập nhật danh mục: " + ex.Message } } });
            }
        }
