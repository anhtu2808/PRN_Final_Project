...
namespace LaptopRentalManagement.Pages.Manage
{
    public class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            MonthlyRevenueChartDataJson = JsonSerializer.Serialize(new { labels = monthlyRevenueLabels, values = monthlyRevenueValues });
            ...
            OrderStatusChartDataJson = JsonSerializer.Serialize(new { labels = orderStatusLabels, values = orderStatusValues });
